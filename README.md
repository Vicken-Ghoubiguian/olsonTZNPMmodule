...
// getting geographic region from all wished timezones stocked in the 'wishedTimezonesArray' array...
var olsonArray_geographic_region = olsonTZNPMmodule.getGeographicRegionFromMultipleTimezones(wishedTimezonesArray);

// display the 'olsonArray_geographic_region' associative array which contains all returning timezones as key and their geographic region as values...
console.log(olsonArray_geographic_region);
