...
var timezones = [
	...
	{timezone: "Etc/UTC", country_code: "NaNC", moment: moment.tz("Etc/UTC"), color: "#1c4966"},
	{timezone: "Etc/GMT", country_code: "NaNC", moment: moment.tz("Etc/GMT"), color: "#1c4966"},
	...
	{timezone: "Africa/Algiers", country_code: "DZ", moment: moment.tz("Africa/Algiers"), color: "#ffdf00"},
	{timezone: "Africa/Asmara", country_code: "ER", moment: moment.tz("Africa/Asmara"), color: "#ffdf00"},
	{timezone: "Africa/Bamako", country_code: "ML", moment: moment.tz("Africa/Bamako"), color: "#ffdf00"},
	{timezone: "Africa/Bangui", country_code: "CF", moment: moment.tz("Africa/Bangui"), color: "#ffdf00"},
	{timezone: "Africa/Banjul", country_code: "GM", moment: moment.tz("Africa/Banjul"), color: "#ffdf00"},
	{timezone: "Africa/Bissau", country_code: "GW", moment: moment.tz("Africa/Bissau"), color: "#ffdf00"},
	{timezone: "Africa/Blantyre", country_code: "MW", moment: moment.tz("Africa/Blantyre"), color: "#ffdf00"},
	{timezone: "Africa/Brazzaville", country_code: "CG", moment: moment.tz("Africa/Brazzaville"), color: "#ffdf00"},
	{timezone: "Africa/Bujumbura", country_code: "BI", moment: moment.tz("Africa/Bujumbura"), color: "#ffdf00"},
	{timezone: "Africa/Cairo", country_code: "EG", moment: moment.tz("Africa/Cairo"), color: "#ffdf00"},
	{timezone: "Africa/Casablanca", country_code: "MA", moment: moment.tz("Africa/Casablanca"), color: "#ffdf00"},
	{timezone: "Africa/Ceuta", country_code: "ES", moment: moment.tz("Africa/Ceuta"), color: "#ffdf00"},
	{timezone: "Africa/Conakry", country_code: "GN", moment: moment.tz("Africa/Conakry"), color: "#ffdf00"},
	{timezone: "Africa/Dakar", country_code: "SN", moment: moment.tz("Africa/Dakar"), color: "#ffdf00"},
	{timezone: "Africa/Dar_es_Salaam", country_code: "TZ", moment: moment.tz("Africa/Dar_es_Salaam"), color: "#ffdf00"},
	{timezone: "Africa/Djibouti", country_code: "DJ", moment: moment.tz("Africa/Djibouti"), color: "#ffdf00"},
	{timezone: "Africa/Douala", country_code: "CM", moment: moment.tz("Africa/Douala"), color: "#ffdf00"},
	{timezone: "Africa/El_Aaiun", country_code: "EH", moment: moment.tz("Africa/El_Aaiun"), color: "#ffdf00"},
	{timezone: "Africa/Freetown", country_code: "SL", moment: moment.tz("Africa/Freetown"), color: "#ffdf00"},
	{timezone: "Africa/Gaborone", country_code: "BW", moment: moment.tz("Africa/Gaborone"), color: "#ffdf00"},
	{timezone: "Africa/Harare", country_code: "ZW", moment: moment.tz("Africa/Harare"), color: "#ffdf00"},
	{timezone: "Africa/Johannesburg", country_code: "ZA", moment: moment.tz("Africa/Johannesburg"), color: "#ffdf00"},
	{timezone: "Africa/Juba", country_code: "SS", moment: moment.tz("Africa/Juba"), color: "#ffdf00"},
	{timezone: "Africa/Kampala", country_code: "UG", moment: moment.tz("Africa/Kampala"), color: "#ffdf00"},
	{timezone: "Africa/Khartoum", country_code: "SD", moment: moment.tz("Africa/Khartoum"), color: "#ffdf00"},
	{timezone: "Africa/Kigali", country_code: "RW", moment: moment.tz("Africa/Kigali"), color: "#ffdf00"},
	{timezone: "Africa/Kinshasa", country_code: "CD", moment: moment.tz("Africa/Kinshasa"), color: "#ffdf00"},
	{timezone: "Africa/Lagos", country_code: "NG", moment: moment.tz("Africa/Lagos"), color: "#ffdf00"},
	{timezone: "Africa/Libreville", country_code: "GA", moment: moment.tz("Africa/Libreville"), color: "#ffdf00"},
	{timezone: "Africa/Lome", country_code: "TG", moment: moment.tz("Africa/Lome"), color: "#ffdf00"},
	{timezone: "Africa/Luanda", country_code: "AO", moment: moment.tz("Africa/Luanda"), color: "#ffdf00"},
	{timezone: "Africa/Lubumbashi", country_code: "CD", moment: moment.tz("Africa/Lubumbashi"), color: "#ffdf00"},
	{timezone: "Africa/Lusaka", country_code: "ZM", moment: moment.tz("Africa/Lusaka"), color: "#ffdf00"},
	{timezone: "Africa/Malabo", country_code: "GQ", moment: moment.tz("Africa/Malabo"), color: "#ffdf00"},
	{timezone: "Africa/Maputo", country_code: "MZ", moment: moment.tz("Africa/Maputo"), color: "#ffdf00"},
	{timezone: "Africa/Maseru", country_code: "LS", moment: moment.tz("Africa/Maseru"), color: "#ffdf00"},
	{timezone: "Africa/Mbabane", country_code: "SZ", moment: moment.tz("Africa/Mbabane"), color: "#ffdf00"},
	{timezone: "Africa/Mogadishu", country_code: "SO", moment: moment.tz("Africa/Mogadishu"), color: "#ffdf00"},
	{timezone: "Africa/Monrovia", country_code: "LR", moment: moment.tz("Africa/Monrovia"), color: "#ffdf00"},
	{timezone: "Africa/Nairobi", country_code: "KE", moment: moment.tz("Africa/Nairobi"), color: "#ffdf00"},
	{timezone: "Africa/Ndjamena", country_code: "TD", moment: moment.tz("Africa/Ndjamena"), color: "#ffdf00"},
	{timezone: "Africa/Niamey", country_code: "NE", moment: moment.tz("Africa/Niamey"), color: "#ffdf00"},
	{timezone: "Africa/Nouakchott", country_code: "MR", moment: moment.tz("Africa/Nouakchott"), color: "#ffdf00"},
	{timezone: "Africa/Ouagadougou", country_code: "BF", moment: moment.tz("Africa/Ouagadougou"), color: "#ffdf00"},
	{timezone: "Africa/Porto-Novo", country_code: "BJ", moment: moment.tz("Africa/Porto-Novo"), color: "#ffdf00"},
	{timezone: "Africa/Sao_Tome", country_code: "ST", moment: moment.tz("Africa/Sao_Tome"), color: "#ffdf00"},
	{timezone: "Africa/Tripoli", country_code: "LY", moment: moment.tz("Africa/Tripoli"), color: "#ffdf00"},
	{timezone: "Africa/Tunis", country_code: "TN", moment: moment.tz("Africa/Tunis"), color: "#ffdf00"},
	{timezone: "Africa/Windhoek", country_code: "NA", moment: moment.tz("Africa/Windhoek"), color: "#ffdf00"},
	...
	{timezone: "Antarctica/Casey", country_code: "AQ", moment: moment.tz("Antarctica/Casey"), color: "#FFC0CB"},
	{timezone: "Antarctica/Davis", country_code: "AQ", moment: moment.tz("Antarctica/Davis"), color: "#FFC0CB"},
	{timezone: "Antarctica/DumontDUrville", country_code: "AQ", moment: moment.tz("Antarctica/DumontDUrville"), color: "#FFC0CB"},
	{timezone: "Antarctica/Macquarie", country_code: "AU", moment: moment.tz("Antarctica/Macquarie"), color: "#FFC0CB"},
	{timezone: "Antarctica/Mawson", country_code: "AQ", moment: moment.tz("Antarctica/Mawson"), color: "#FFC0CB"},
	{timezone: "Antarctica/McMurdo", country_code: "AQ", moment: moment.tz("Antarctica/McMurdo"), color: "#FFC0CB"},
	{timezone: "Antarctica/Palmer", country_code: "AQ", moment: moment.tz("Antarctica/Palmer"), color: "#FFC0CB"},
	{timezone: "Antarctica/Rothera", country_code: "AQ", moment: moment.tz("Antarctica/Rothera"), color: "#FFC0CB"},
	{timezone: "Antarctica/Syowa", country_code: "AQ", moment: moment.tz("Antarctica/Syowa"), color: "#FFC0CB"},
	{timezone: "Antarctica/Troll", country_code: "AQ", moment: moment.tz("Antarctica/Troll"), color: "#FFC0CB"},
	{timezone: "Antarctica/Vostok", country_code: "AQ", moment: moment.tz("Antarctica/Vostok"), color: "#FFC0CB"},

	//Arctic ocean's timezones...
	{timezone: "Arctic/Longyearbyen", country_code: "SJ", moment: moment.tz("Arctic/Longyearbyen"), color: "#FD6C9E"},
	...
	{timezone: "Australia/Adelaide", country_code: "AU", moment: moment.tz("Australia/Adelaide"), color: "#0091AD"},
	{timezone: "Australia/Brisbane", country_code: "AU", moment: moment.tz("Australia/Brisbane"), color: "#0091AD"},
	{timezone: "Australia/Broken_Hill", country_code: "AU", moment: moment.tz("Australia/Broken_Hill"), color: "#0091AD"},
	{timezone: "Australia/Currie", country_code: "AU", moment: moment.tz("Australia/Currie"), color: "#0091AD"},
	{timezone: "Australia/Darwin", country_code: "AU", moment: moment.tz("Australia/Darwin"), color: "#0091AD"},
	{timezone: "Australia/Eucla", country_code: "AU", moment: moment.tz("Australia/Eucla"), color: "#0091AD"},
	{timezone: "Australia/Hobart", country_code: "AU", moment: moment.tz("Australia/Hobart"), color: "#0091AD"},
	{timezone: "Australia/Lindeman", country_code: "AU", moment: moment.tz("Australia/Lindeman"), color: "#0091AD"},
	{timezone: "Australia/Lord_Howe", country_code: "AU", moment: moment.tz("Australia/Lord_Howe"), color: "#0091AD"},
	{timezone: "Australia/Melbourne", country_code: "AU", moment: moment.tz("Australia/Melbourne"), color: "#0091AD"},
	{timezone: "Australia/Perth", country_code: "AU", moment: moment.tz("Australia/Perth"), color: "#0091AD"},
	{timezone: "Australia/Sydney", country_code: "AU", moment: moment.tz("Australia/Sydney"), color: "#0091AD"},
	...
	{timezone: "Indian/Antananarivo", country_code: "MG", moment: moment.tz("Indian/Antananarivo"), color: "#33FFA2"},
	{timezone: "Indian/Chagos", country_code: "IO", moment: moment.tz("Indian/Chagos"), color: "#33FFA2"},
	{timezone: "Indian/Christmas", country_code: "CX", moment: moment.tz("Indian/Christmas"), color: "#33FFA2"},
	{timezone: "Indian/Cocos", country_code: "CC", moment: moment.tz("Indian/Cocos"), color: "#33FFA2"},
	{timezone: "Indian/Comoro", country_code: "KM", moment: moment.tz("Indian/Comoro"), color: "#33FFA2"},
	{timezone: "Indian/Kerguelen", country_code: "TF", moment: moment.tz("Indian/Kerguelen"), color: "#33FFA2"},
	{timezone: "Indian/Mahe", country_code: "SC", moment: moment.tz("Indian/Mahe"), color: "#33FFA2"},
	{timezone: "Indian/Maldives", country_code: "MV", moment: moment.tz("Indian/Maldives"), color: "#33FFA2"},
	{timezone: "Indian/Mauritius", country_code: "MU", moment: moment.tz("Indian/Mauritius"), color: "#33FFA2"},
	{timezone: "Indian/Mayotte", country_code: "YT", moment: moment.tz("Indian/Mayotte"), color: "#33FFA2"},
	{timezone: "Indian/Reunion", country_code: "RE", moment: moment.tz("Indian/Reunion"), color: "#33FFA2"},
	...
	{timezone: "Pacific/Midway", country_code: "US", moment: moment.tz("Pacific/Midway"), color: "#4B0082"},
